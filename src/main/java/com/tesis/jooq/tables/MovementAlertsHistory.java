...
public class MovementAlertsHistory extends TableImpl<MovementAlertsHistoryRecord> {
    ...
    private static final long serialVersionUID = 1407375221;
     ...
     */
    public final TableField<MovementAlertsHistoryRecord, LocalDateTime> TIME = createField(DSL.name("time"), org.jooq.impl.SQLDataType.LOCALDATETIME.nullable(false), this, "");

    /**
     * The column <code>public.movement_alerts_history.alert_id</code>.
     */
    public final TableField<MovementAlertsHistoryRecord, Long> ALERT_ID = createField(DSL.name("alert_id"), org.jooq.impl.SQLDataType.BIGINT, this, "");

    /**
     * The column <code>public.movement_alerts_history.lat</code>.
     */
    public final TableField<MovementAlertsHistoryRecord, Float> LAT = createField(DSL.name("lat"), org.jooq.impl.SQLDataType.REAL, this, "");

    /**
     * The column <code>public.movement_alerts_history.lng</code>.
     */
    public final TableField<MovementAlertsHistoryRecord, Float> LNG = createField(DSL.name("lng"), org.jooq.impl.SQLDataType.REAL, this, "");
