...
public class VehiclesRecord extends UpdatableRecordImpl<VehiclesRecord> implements Record6<Long, Timestamp, Timestamp, String, String, String> {

    private static final long serialVersionUID = -995160107;
     ...
     */
    @Override
    public VehiclesRecord values(Long value1, Timestamp value2, Timestamp value3, String value4, String value5, String value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public VehiclesRecord(Long id, Timestamp deletedAt, Timestamp lastUpdated, String type, String plate, String model) {
        super(Vehicles.VEHICLES);
