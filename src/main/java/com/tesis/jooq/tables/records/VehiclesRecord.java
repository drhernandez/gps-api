...
public class VehiclesRecord extends UpdatableRecordImpl<VehiclesRecord> implements Record7<Long, Timestamp, Timestamp, Long, String, String, String> {

    private static final long serialVersionUID = -666096932;
     ...
     */
    @Override
    public Row7<Long, Timestamp, Timestamp, Long, String, String, String> fieldsRow() {
     ...
     */
    @Override
    public Row7<Long, Timestamp, Timestamp, Long, String, String, String> valuesRow() {
     ...
     */
    @Override
    public VehiclesRecord values(Long value1, Timestamp value2, Timestamp value3, Long value4, String value5, String value6, String value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public VehiclesRecord(Long id, Timestamp deletedAt, Timestamp lastUpdated, Long userId, String type, String plate, String model) {
        super(Vehicles.VEHICLES);
