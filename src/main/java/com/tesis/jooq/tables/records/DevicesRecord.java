...
public class DevicesRecord extends UpdatableRecordImpl<DevicesRecord> implements Record6<Long, Timestamp, Timestamp, Long, String, String> {

    private static final long serialVersionUID = -1737006219;
     ...
     */
    @Override
    public Row6<Long, Timestamp, Timestamp, Long, String, String> fieldsRow() {
     ...
     */
    @Override
    public Row6<Long, Timestamp, Timestamp, Long, String, String> valuesRow() {
     ...
     */
    @Override
    public DevicesRecord values(Long value1, Timestamp value2, Timestamp value3, Long value4, String value5, String value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public DevicesRecord(Long id, Timestamp deletedAt, Timestamp lastUpdated, Long vehicleId, String model, String softwareVersion) {
        super(Devices.DEVICES);
