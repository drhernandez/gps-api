...
public class Vehicles extends TableImpl<VehiclesRecord> {
    ...
    private static final long serialVersionUID = -233969284;
     ...
     */
    public final TableField<VehiclesRecord, Long> ID = createField(DSL.name("id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("nextval('vehicles_id_seq'::regclass)", org.jooq.impl.SQLDataType.BIGINT)), this, "");

    /**
     * The column <code>public.vehicles.status</code>.
     */
    public final TableField<VehiclesRecord, String> STATUS = createField(DSL.name("status"), org.jooq.impl.SQLDataType.VARCHAR.nullable(false), this, "");

    /**
     * The column <code>public.vehicles.deleted_at</code>.
     */
    public final TableField<VehiclesRecord, LocalDateTime> DELETED_AT = createField(DSL.name("deleted_at"), org.jooq.impl.SQLDataType.LOCALDATETIME, this, "");

    /**
     * The column <code>public.vehicles.last_updated</code>.
     */
    public final TableField<VehiclesRecord, LocalDateTime> LAST_UPDATED = createField(DSL.name("last_updated"), org.jooq.impl.SQLDataType.LOCALDATETIME, this, "");

    /**
     * The column <code>public.vehicles.user_id</code>.
     */
    public final TableField<VehiclesRecord, Long> USER_ID = createField(DSL.name("user_id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>public.vehicles.device_id</code>.
     */
    public final TableField<VehiclesRecord, Long> DEVICE_ID = createField(DSL.name("device_id"), org.jooq.impl.SQLDataType.BIGINT, this, "");

    /**
     * The column <code>public.vehicles.plate</code>.
     */
    public final TableField<VehiclesRecord, String> PLATE = createField(DSL.name("plate"), org.jooq.impl.SQLDataType.VARCHAR.nullable(false), this, "");

    /**
     * The column <code>public.vehicles.brand</code>.
     */
    public final TableField<VehiclesRecord, String> BRAND = createField(DSL.name("brand"), org.jooq.impl.SQLDataType.VARCHAR, this, "");

    /**
     * The column <code>public.vehicles.brand_line</code>.
     */
    public final TableField<VehiclesRecord, String> BRAND_LINE = createField(DSL.name("brand_line"), org.jooq.impl.SQLDataType.VARCHAR, this, "");
